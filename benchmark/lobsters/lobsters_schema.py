...
title.set_value_generator(lambda: fake.text(max_nb_chars=64).replace('\t', ' ').replace('\n', ' '))
...
markeddown_description.set_value_generator(lambda: fake.text(max_nb_chars=256).replace('\t', ' ').replace('\n', ' '))
story_cache = Field('story_cache', 'string')
story_cache.set_value_generator(lambda: fake.text(max_nb_chars=256).replace('\t', ' ').replace('\n', ' '))
...
comment_comment.set_value_generator(lambda: fake.text(max_nb_chars=256).replace('\t', ' ').replace('\n', ' '))
upvotes = Field('upvotes', 'int')
downvotes = Field('downvotes', 'int')
confidence = Field('confidence', 'float')
markeddown_comment = Field('markeddown_comment', 'string')
markeddown_comment.set_value_generator(lambda: fake.text(max_nb_chars=256).replace('\t', ' ').replace('\n', ' '))
...
body.set_value_generator(lambda: fake.text(max_nb_chars=256).replace('\t', ' ').replace('\n', ' '))
short_id = Field('short_id', 'varchar(8)')
...
settings.set_value_generator(lambda: fake.text(max_nb_chars=256).replace('\t', ' ').replace('\n', ' '))
