...
read_queries = [q_ct_2]
#search_plans_for_one_query(q_ct_2)
ilp_solve(read_queries, write_queries=[], membound_factor=1.2, save_to_file=True, read_from_file=False, read_ilp=False, save_ilp=True)
test_read_overall(tables, associations, read_queries, memfactor=1.2, read_from_file=True, read_ilp=True)
