...
q_ht_1.finclude(f('tags'), pfilter=BinOp(f('id'), EQ, param_tag), projection=[f('tag'),f('id')])
q_ht_1.finclude(f('votes'), pfilter=ConnectOp(BinOp(f('user').f('id'), EQ, param_user_id), AND, BinOp(f('comment_id'), EQ, AtomValue(0))), projection=[f('vote'),f('id')])
