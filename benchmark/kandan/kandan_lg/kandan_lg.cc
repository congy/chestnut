#include "kandan_lg.h"
TreeIndex<oid_t, size_t, 10000000> idptr_ds_1;
TreeIndex<oid_t, size_t, 500> idptr_ds_16;
BasicArray<Activity1, 10000000> activity_1;
SmallBasicArray<User4, 200000> user_4;
SortedArray<ds_12_key_type, Attachment12, 40000> ds_12;
SmallBasicArray<Channel16, 500> channel_16;
SortedArray<ds_22_key_type, Channel22, 500> ds_22;
TreeIndex<ds_35_key_type, ItemPointer, 10000000> ds_35;
...
void read_data() {
  ...
  for (size_t i=0; i<10000000; i++)
  init_ds_35_from_sql(conn, i);
  printf("finish initialize ds 35\n");
  init_ds_43_from_sql(conn);
  printf("finish initialize ds 43\n");
  oid_t obj_pos = 0;
  cnt = 0;
  BASICARRAY_FOR_BEGIN(activity_1_1, activity_1, obj_activity_1)
