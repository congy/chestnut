...
delayed_job.add_fields([d_priority,d_attempts,d_handler,d_last_error,d_run_at,d_locked_at,d_failed_at,d_queue,d_created_at,d_updated_at])
...
u_sign_in_count = Field('sign_in_count','uint8')
...
u_failed_attempts = Field('failed_attempts','uint8')
