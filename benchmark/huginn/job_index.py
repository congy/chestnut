...
p1_1 = BinOp(f('run_at'), LT, Parameter('run_at'))
#p1_2 = BinOp(f('failed_at'), EQ, AtomValue('0000-00-00 00:00:00'))
p1_2 = BinOp(f('priority'), EQ, AtomValue(1))
p2 = ConnectOp(p1_1, AND, p1_2)
p3 = BinOp(f('locked_at'), LT, Parameter('time2'))
p4 = BinOp(f('locked_by'), EQ, Parameter('lockedby'))
...
q_ji_4.pfilter(ConnectOp(ConnectOp(p2, AND, p3), OR, ConnectOp(p2, AND, p4)))
